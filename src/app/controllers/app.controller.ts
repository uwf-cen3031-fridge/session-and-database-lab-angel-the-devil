...
export class AppController {
  ...
  private initializeRouter() {
    ...
    this.router.get("/logout", function (req:any, res:Response) {
      delete req.session.user;
      res.render("login");
    });

    this.router.get("/signup", function (req:Request, res:Response) {
      res.render("signup");
    });
    ...
    this.router.post("/processLogin", async (req: any, res:Response) => {
